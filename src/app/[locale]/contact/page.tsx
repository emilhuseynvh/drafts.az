                        ...
                        <Form className="!max-w-xl w-full">
                            <div className="mb-6 flex flex-col md:flex-row gap-6">
                                <div className="w-full">
                                    <Field name="name" type="text" onFocus={() => setFocusedField('name')} className={`bg-[#F7F7F1] border border-[#AAA] text-[#909090] ${focusedField ? 'text-[#151515]' : 'text-[#909090]'} text-sm rounded-xl block w-full py-3 px-4`} placeholder={t("contact.form.name")} />
                            ...
                            <div className='mb-6'>
                                <Field name="email" type="email" onFocus={() => setFocusedField('email')} className={`bg-[#F7F7F1] border border-[#AAA] ${focusedField ? 'text-[#151515]' : 'text-[#909090]'} text-sm rounded-xl block w-full py-3 px-4`} placeholder={t("contact.form.email")} />
                                {errors.email && touched.email ? <p className="text-primary text-xs">{errors.email}</p> : null}
                            </div>
                            <div className='mb-4'>
                                <Field as="textarea" name="area" onFocus={() => setFocusedField('area')} className={`bg-[#F7F7F1] border border-[#AAA] ${focusedField ? 'text-[#151515]' : 'text-[#909090]'} text-sm rounded-xl block w-full py-3 px-4`} rows={9} placeholder={t("contact.form.area")} />
