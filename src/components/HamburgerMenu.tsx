        ...
        <div className={`bg-primary-bg ${flag ? 'right-0' : '-right-full'} duration-500 w-full top-17 h-screen fixed z-50 md:hidden flex justify-end px-4 py-7`}>
            <div>
                <ul className='text-end text-primary-white text-4xl'>
                    <li className='my-3.5 font-light'>{t('header.list.home_page')}</li>
                    <li className='my-3.5 font-light'>{t('header.list.services')}</li>
                    <li className='my-3.5 font-light'>{t('header.list.about')}</li>
                    <li className='my-3.5 font-light'>{t('header.list.contact')}</li>
                </ul>
                <div>
