...
const Button: React.FC<ButtonProps> = ({ children, bgColor, width }) => {
  return (
    <button style={{ backgroundColor: bgColor, width: width }} className={` cursor-pointer bg-white relative flex justify-center overflow-hidden group rounded-xl h-12 gap-2 items-center w-[271px]`}>
      {children}
